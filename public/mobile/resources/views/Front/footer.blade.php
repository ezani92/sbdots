<div class="container">
        <div class="row margin-style2 margin-none-side">
            <div class="col banks">
    ...
    <nav role="navigation" class="navbar navbar-inverse navbar-fixed-bottom barFixed">
        <div class="container">
            <div class="row">
                    ...
                    <li class="active">
                        <div class="col-xs-3 footer-xs ">
                            <a href="#" target="_blank">
                                ...
                                <img src="images/common/icon-facebook.png"/>facebook</button>
                            </a>
                        </div>
                    </li>
                    <li>
                        <div class="col-xs-3 footer-xs">
                            <a href="banking">
                                <button href="#" class="navbar-toggle collapsed btn-bottom" type="button"> 
                                <img src="images/common/icon-bank.png"/>banking</button>
                            </a>
                        </div>
                    </li>
                    <li>
                        <div class="col-xs-3 footer-xs">
                            <a href="contactus">
                                <button href="#" class="navbar-toggle collapsed btn-bottom" type="button"> 
                                <img src="images/common/icon-contact.png"/>contact us</button>
                            </a>
                        </div>
                    </li>
                    <li>
                        <div class="col-xs-3 footer-xs">
                            <a href="#" data-toggle="modal" data-target="#language">
                                ...
                                <img src="images/common/icon-language.png"/>language</button>
                            </a>
                        </div>
                    </li>
                </ul>
