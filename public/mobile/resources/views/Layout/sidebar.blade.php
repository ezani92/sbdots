<div id="sidebar" class="page-sidebar">
    <div class="page-sidebar-scroll">
        ...
        <div class="navigation-items">
            ...
            <div class="nav-item">
                <a href="home" class="main-nav active" style="background-image: url(images/common/icon-home.png);">Home</a>
            </div>
            <div class="nav-item">
            ...
            <div class="nav-item">
                <a href="arcade" class="main-nav " style="background-image: url(images/common/icon-games.png);">Arcade</a>
            </div> 
            <div class="nav-item">
                <a href="lottery" class="main-nav " style="background-image: url(images/common/icon-poker.png);">Lottery</a>
            </div> 
            <div class="nav-item">
