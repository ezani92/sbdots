            ...
            <div>
                ...
                <div class="container bg-dark">
                    ...
                    <div id="ourHolder" class="promo-box">
                        ...
                        <div class="promo new">
                            <h3><img src="{{ asset('images/en/bnr1.jpg') }}" class="img-responsive width-full"/></h3>
                        ...
                        <div class="promo new latest">
                            <h3><img src="{{ asset('images/en/bnr2.jpg') }}" class="img-responsive width-full"/></h3>
                            <div class="promo-font">
                        ...
                        <div class="promo deposit">
                            <h3><img src="{{ asset('images/en/bnr4.jpg') }}" class="img-responsive width-full"/></h3>
                            <div class="promo-font">
                        ...
                        <div class="promo deposit latest">
                            <h3><img src="{{ asset('images/en/bnr3.jpg') }}" class="img-responsive width-full"/></h3>
                            <div class="promo-font">
                        ...
                        <div class="promo rebate">
                            <h3><img src="{{ asset('images/en/bnr5.jpg') }}" class="img-responsive width-full"/></h3>
                            <div class="promo-font">
                            ...
                            <div class="promo special">
                                <h3><img src="{{ asset('images/en/bnr6.jpg') }}" class="img-responsive width-full"/></h3>
                                <div class="promo-font">
