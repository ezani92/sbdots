    ...
    <div id="header">
        <div class="headWrap container">
            <div class="logo"><a href="{{ url('/') }}">
                <img src="{{ asset('images/common/SB_Dot_logo_black-01.png') }}" alt="" height="120px">
            </a></div>
            @if(Auth::guest())
            ...
            <div class="container">
                ...
                <div class="slider-wrapper theme-default">
                    <div id="slider" class="nivoSlider" style="height:350px;"> 
                        ...
                        <a href="promotions"><img src="images/en/banner-2_em-sportdbook10.jpg" width="1040" height="350" alt=""/></a>
